...
[Download FrankCards v2.0.0](https://github.com/SonghaiFan/frank_cards/releases/tag/v2.0.0) · [All releases](https://github.com/SonghaiFan/frank_cards/releases) · [中文](../README.md) / **English**
...
Built-in packs work without an account. Topics you create are saved to your account.
...
Download the right installer from the [FrankCards v2.0.0 release](https://github.com/SonghaiFan/frank_cards/releases/tag/v2.0.0).
